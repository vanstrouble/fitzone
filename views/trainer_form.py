...
class TrainerFormView(ctk.CTkFrame):
    ...
    def _create_widgets(self):
        ...
        self.specialty_label = ctk.CTkLabel(
            form, text="Specialty:", font=ctk.CTkFont(size=14, weight="bold")
        )
        self.specialty_label.pack(anchor="w", pady=(0, 5))
        self.specialty_entry = ctk.CTkEntry(
            form, height=36, placeholder_text="Enter specialty", corner_radius=8
        )
        ...
        self.start_label = ctk.CTkLabel(
            time_frame, text="Start (HH:MM):", font=ctk.CTkFont(size=14)
        )
        self.start_label.grid(row=0, column=0, sticky="w")
        self.start_entry = ctk.CTkEntry(
            time_frame, height=36, placeholder_text="08:00", corner_radius=8
        )
        ...
        self.end_label = ctk.CTkLabel(
            time_frame, text="End (HH:MM):", font=ctk.CTkFont(size=14)
        )
        self.end_label.grid(row=0, column=1, sticky="w")
        self.end_entry = ctk.CTkEntry(
            time_frame, height=36, placeholder_text="17:00", corner_radius=8
        )
        ...
        self.manager_combo = ctk.CTkComboBox(
            form, values=[""] + managers, height=36, corner_radius=8
        )
